...
const EMAIL_TEMPLATES: Record<string, React.ComponentType<Record<string, unknown>>> = {
  ...
  reauthentication: ReauthenticationEmail as unknown as React.ComponentType<
    Record<string, unknown>
  >,
};

// Configuration
const SITE_NAME = "Days Inn Hub";
const ROOT_DOMAIN = "daysinn.app";
...
const SAMPLE_PROJECT_URL = "https://daysinn.lovable.app";
