...
const Email = ({ guestName, checkIn, checkOut, roomType, guests, confirmationCode }: Props) => (
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          {guestName ? `Hi ${guestName},` : "Hi there,"} thanks for booking with us. Here are your
          stay details.
        </Text>
        <Section style={card}>
        ...
        <Text style={text}>
          Check-in opens at 3:00 PM. Scan the QR code at the front desk to activate your room tools
          on your phone.
        </Text>
        <Hr style={hr} />
