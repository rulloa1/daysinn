  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          {guestName ? `Hi ${guestName},` : "Hi there,"} the front desk updated your stay. Here's
          what changed.
        </Text>
        ...
        <Text style={text}>
          If anything looks wrong, reply to this email or call the front desk and we'll fix it right
          away.
        </Text>
        <Hr style={hr} />
