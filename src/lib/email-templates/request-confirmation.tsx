...
const Email = ({ guestName, roomNumber, requestType, details, referenceId }: Props) => (
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          {guestName ? `Hi ${guestName},` : "Hi there,"} our front desk team has received your
          request{roomNumber ? ` for room ${roomNumber}` : ""} and is on it.
        </Text>
        <Section style={card}>
        ...
        <Text style={text}>
          You'll get an update as soon as a team member picks it up. Need something urgent? Call the
          front desk any time.
        </Text>
        <Hr style={hr} />
